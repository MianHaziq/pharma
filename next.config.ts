...
const nextConfig: NextConfig = {
  ...
  images: {
    // Editorial photography is served from Unsplash and Pexels for this demo.
    // Swap these for the client's own asset host (or a CMS domain) when real
    // photography is connected — no component changes required.
    remotePatterns: [
